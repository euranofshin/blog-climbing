...
[Add a graph showing the different values for armed and dangerous]
...
It's clear that a gender gap exists in the length of time it taks to send a route across all grades. 
